...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Admin Sewa Alat Fitnes</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <?php echo $this->session->admin->name ;?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <p>
                                    <?php echo $this->session->admin->name ?>
                                    <small>Member since <?php echo $this->session->admin->created_at ?></small>
                                </p>
                            </li>
                            <!-- Menu Footer-->
            ...
            <ul class="sidebar-menu" data-widget="tree">
				...
				<li class="<?php echo ($this->uri->segment(2) == "contact-us")? " active": ""; ?>">
					<a href="<?php echo base_url('index.php/admin/contact-us') ?>">
						<i class="fa fa-phone"></i> <span>Message</span>
					</a>
				</li>
            </ul>
        </section>
