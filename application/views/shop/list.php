...
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/libs/noui/nouislider.min.css">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(<?php echo base_url('assets/images/header/fitnes.jpg') ?>">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					...
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<div class="search-product pos-relative bo4 of-hidden">
							<input class="s-text7 size6 p-l-23 p-r-50" type="text" name="search_str" value="<?php echo $this->input->get('search_str'); ?>" id="search-product" placeholder="Cari Alat fitnes...">
