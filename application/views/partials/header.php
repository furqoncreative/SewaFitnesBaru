        ...
        <div class="wrap_header">
            ...
            <div class="wrap_menu">
                <nav class="menu">
                    <ul class="main_menu">
                        <li>
                            <a href="<?php echo base_url('index.php/shop') ?>">Home</a>
                        </li>
            ...
            <div class="header-icons">
				...
				<?php echo form_open(base_url('index.php/logout-user')) ?>
				...
				<?php echo form_open(base_url('index.php/signup-form')) ?>
            ...
            <div class="header-icons-mobile">
                ...
                <div class="header-wrapicon2">
                    ...
                    <div class="header-cart header-dropdown">
                        ...
                        <div class="header-cart-total">
                            Total: Rp <?php echo $this->cart->total(); ?>
                        </div>
