...
$route['login-admin'] = 'Auth/LoginAdminController/showLoginForm';
$route['signup-form'] = 'Auth/SignupController';
$route['signup'] = 'Auth/SignupController/signUp';
$route['logout']['POST'] = 'Auth/LogoutAdminController/logout';
$route['logout-user']['POST'] = 'Auth/LogoutController/logout';
...
$route['cetak-order'] = 'Cetak/CetakOrder';
...
$route['api/getproduct'] = 'Api/GetProducts';
$route['api/getuser'] = 'Api/GetUsers';
